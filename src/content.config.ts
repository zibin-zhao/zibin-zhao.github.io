...
const vibe = defineCollection({
  ...
  schema: z.object({ title: z.string(), titleZh: z.string().optional(), blurb: z.string(), blurbZh: z.string().optional(), tags: z.array(z.string()).default([]), href: z.string().optional(), githubUrl: z.string().optional(), screenshot: z.string().optional(), preview: z.enum(['medit']).optional(), comingSoon: z.boolean().default(false), order: z.number().default(0) }),
});
